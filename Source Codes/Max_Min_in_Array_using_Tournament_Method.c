...
In tournament method we divide the array in two halves and compare the true maximum of left half and right half, and true minimum of left half and right half.
*/
#include<stdio.h>
#include<stdlib.h>
